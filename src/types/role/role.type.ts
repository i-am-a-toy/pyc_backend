...
export class Role extends EnumType<Role>() {
  ...
  static readonly NEWBIE_TEAM_LEADER = new Role(6, 'NEWBIE_TEAM_LEADER', '새친구팀장');
  static readonly LEADER = new Role(7, 'LEADER', '셀리더');
  static readonly MEMBER = new Role(8, 'MEMBER', '셀원');
  static readonly NEWBIE = new Role(9, 'NEWBIE', '새신자');
